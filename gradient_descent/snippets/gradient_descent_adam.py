...
from gradient_descent.gradient_descent import gradient_descent_Adam, plot_graph
...
# tag::beale_function_gradient_descent_adam
...
# end::beale_function_gradient_descent_adam

path = np.asarray(path)
fig = plot_graph(path, x, y, z, minima_, xmin, xmax, ymin, ymax)
fig.savefig("assets/beale_function_gradient_descent_adam_path.png")
