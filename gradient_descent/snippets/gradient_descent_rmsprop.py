...
from gradient_descent.gradient_descent import gradient_descent_RMSprop, plot_graph
...
# tag::beale_function_gradient_descent_rmsprop
...
# end::beale_function_gradient_descent_rmsprop

path = np.asarray(path)
fig = plot_graph(path, x, y, z, minima_, xmin, xmax, ymin, ymax)
fig.savefig("assets/beale_function_gradient_descent_rmsprop_path.png")
